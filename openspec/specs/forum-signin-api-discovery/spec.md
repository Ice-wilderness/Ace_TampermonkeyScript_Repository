...
Provide a project-side development tool for collecting forum sign-in API, form, page, token, and response clues during site maintenance without embedding discovery behavior in the released userscript or modifying daily sign-in state.
